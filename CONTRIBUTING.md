...
Thank you for considering contributing to MiDebloat-Remover.

This project focuses on **SAFETY FIRST** for MIUI and HyperOS devices.
...
```bash
git commit -m "Add: safe debloat for MIUI/HyperOS service X"
```
